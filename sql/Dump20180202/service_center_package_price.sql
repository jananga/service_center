...
CREATE TABLE `package_price` (
  ...
  PRIMARY KEY (`id`),
  KEY `catergory_id_idx` (`catergory_id`),
  KEY `package_id_idx` (`package_id`),
  CONSTRAINT `catergory_id` FOREIGN KEY (`catergory_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `package_id` FOREIGN KEY (`package_id`) REFERENCES `pakage` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
